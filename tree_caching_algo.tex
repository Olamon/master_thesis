...
Now we are ready to upper bound the cost of \textbf{TRC} obtained during phase $P$.
\begin{lemma}
...
result from this article stays, that any online algorithm solving the standard paging problem 
...
1})$-competitive. The cache sizes' designation is defined the same as for the tree caching 
problem. What is sufficient to do is to construct a bijective mapping from any 
